...
<main>
    <div class="container">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post">
            <div class="row mb-3">
                <label for="customerName" class="col-sm-2 col-form-label">Customer Name <span
            ...
            <div class="row mb-3">
                <label for="contactName" class="col-sm-2 col-form-label">Contact Name <span
                        class="text-danger">*</span></label>
                <div class="col-sm-10">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" id="country" name="Country" list="countryOptions"
            ...
            <button type="submit" class="btn btn-sm btn-outline-primary" id="addBtn" name="AddBtn">+ Add
                Customer</button>
        </form>
    </div>
</main>
